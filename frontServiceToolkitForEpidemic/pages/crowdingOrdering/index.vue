	...
	<div class="order-index">
		<div class="selectList">
			<select class="selectBox" v-model="province">
				<option v-for="option in arr" :value="option.name" :key="option.name">{{ option.name }}</option>
			</select>
			<select class="selectBox" v-model="city">
				<option v-for="option in cityArr" :value="option.name" :key="option.name">{{ option.name }}</option>
			</select>
			<select class="selectBox" v-model="district" v-if="district">
				<option v-for="option in districtArr" :value="option.name" :key="option.name">{{ option.name }}</option>
			</select>
		</div>
