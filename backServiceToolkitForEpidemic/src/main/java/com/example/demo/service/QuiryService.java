...
public class QuiryService {
    private final String HOSPITAL = "http://api.map.baidu.com/place/v2/search?query=" + URLEncoder.encode("医院", "UTF-8");
    ...
    public String getHospitalPosition(String area) throws Exception{
        String url = HOSPITAL + "&region=" + URLEncoder.encode(area, "UTF-8") +
